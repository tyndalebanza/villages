 ...
 */
public class StudioFragment extends Fragment implements dashboardAdapter.EditListener{
    ...
    private String get_dashboard_list_url ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_studio, container, false);
        ...
        adapter = new dashboardAdapter(myVillages, getActivity(),this);
...
// SqLite database handler
    ...
    private JsonObjectRequest getDataFromServer(int requestCount) {
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (get_dashboard_list_url + String.valueOf(requestCount),null, new Response.Listener<JSONObject>() {
