...
public class dashboardAdapter extends RecyclerView.Adapter<dashboardAdapter.ViewHolder>  {
    ...
    public dashboardAdapter(List<village_dash> myVillages, Context context,EditListener listener  ) {
        super();
    ...
    public dashboardAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dashboard_adapter_row, parent, false);
        RecyclerView.ViewHolder viewHolder = new dashboardAdapter.ViewHolder(v);
        return (dashboardAdapter.ViewHolder) viewHolder;
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(View itemView) {
            ...
            edit_pen = (ImageView) itemView.findViewById(R.id.edit_pen);
