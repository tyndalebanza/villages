...
public class VillageListActivity extends AppCompatActivity {
    ...
    private DualViewTypeAdapter adapter ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(VillageListActivity.this.getApplicationContext());

        // session manager
        session = new SessionManager(VillageListActivity.this.getApplicationContext());
        ...
        recyclerView.addItemDecoration(new DividerItemDecoration(VillageListActivity.this, LinearLayoutManager.VERTICAL));

        progressDialog = new DelayedProgressDialog();
        // progressDialog.show(getActivity().getSupportFragmentManager(), "tag");
        layoutManager = new LinearLayoutManager(VillageListActivity.this);
        recyclerView.setLayoutManager(layoutManager);

        myVillage = new ArrayList<>();
        requestQueue = Volley.newRequestQueue(VillageListActivity.this);
        //Initializing our superheroes list

        adapter = new DualViewTypeAdapter(myVillage, VillageListActivity.this);
